...
namespace PhysicsEngine {
	...
	private:
		void update_velocity(RigidBody& body, float dt);
		void update_position(RigidBody& body, float dt);

		void add_impulse(RigidBody& body, const vec2& impulse, const vec2& vector_to_contact);
		...
		void resolve_collision(RigidBody& a, RigidBody& b, const CollisionInformation& collision_information, float dt);
